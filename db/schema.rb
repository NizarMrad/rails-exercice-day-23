...
ActiveRecord::Schema.define(version: 2020_08_06_151823) do
  ...
  create_table "privat_messages", force: :cascade do |t|
    t.string "content"
    t.bigint "sender_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["sender_id"], name: "index_privat_messages_on_sender_id"
  end
